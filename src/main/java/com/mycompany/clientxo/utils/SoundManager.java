package com.mycompany.clientxo.utils;
...
public class SoundManager {
    ...
    private void loadSounds() {
        try {
            loadSound(BUTTON_CLICK, "/com/mycompany/clientxo/sounds/button_click.wav");
            loadSound(PLACE_X, "/com/mycompany/clientxo/sounds/place_x.wav");
            loadSound(PLACE_O, "/com/mycompany/clientxo/sounds/place_o.wav");
            loadSound(WIN, "/com/mycompany/clientxo/sounds/win.wav");
            loadSound(LOSE, "/com/mycompany/clientxo/sounds/lose.wav");
            loadSound(DRAW, "/com/mycompany/clientxo/sounds/draw.wav");
        } catch (Exception e) {
